...
class FantasyLandStrategyAnalyzer(DomainService):
    ...
    def _find_best_combination(
        ...
        if (top_eval.hand_type == HandType.THREE_OF_A_KIND or
            middle_eval.hand_type.value >= HandType.FULL_HOUSE.value or
            bottom_eval.hand_type.value >= HandType.FOUR_OF_A_KIND.value):
