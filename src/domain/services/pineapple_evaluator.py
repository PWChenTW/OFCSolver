...
class PineappleHandEvaluator(HandEvaluator):
    ...
    def _calculate_top_row_royalties(self, cards: List[Card], hand_type: HandType) -> int:
        """
    ...
    def _calculate_bottom_middle_royalties(self, cards: List[Card], hand_type: HandType) -> int:
        """
    ...
    def evaluate_hand_with_position(self, cards: List[Card], row_position: str) -> HandRanking:
        """
        ...
        if row_position == "top" and len(cards) == 3:
            ...
            royalty = self._calculate_middle_row_royalties_pineapple(cards, base_ranking.hand_type)
        elif row_position == "bottom" and len(cards) == 5:
            royalty = self._calculate_bottom_row_royalties_pineapple(cards, base_ranking.hand_type)
        else:
            royalty = 0
    ...
    def _calculate_middle_row_royalties_pineapple(self, cards: List[Card], hand_type: HandType) -> int:
    ...
    def _calculate_bottom_row_royalties_pineapple(self, cards: List[Card], hand_type: HandType) -> int:
