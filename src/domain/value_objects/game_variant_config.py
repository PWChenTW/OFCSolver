...
class GameVariantConfig(ValueObject):
    ...
    def __post_init__(self):
        ...
        if self.royalty_top is None:
            object.__setattr__(self, 'royalty_top', {
                "66": 1, "77": 2, "88": 3, "99": 4, "TT": 5,
                "JJ": 6, "QQ": 7, "KK": 8, "AA": 9,
                "222": 10, "333": 11, "444": 12, "555": 13,
                "666": 14, "777": 15, "888": 16, "999": 17,
                "TTT": 18, "JJJ": 19, "QQQ": 20, "KKK": 21, "AAA": 22
            })
            
        if self.royalty_middle is None:
            object.__setattr__(self, 'royalty_middle', {
                "trips": 2,
                "straight": 4,
        ...
        if self.royalty_bottom is None:
            object.__setattr__(self, 'royalty_bottom', {
                "straight": 2,
                "flush": 4,
                "full_house": 6,
                "quads": 10,
