...
from ...value_objects import ExpectedValue, Move
...
class Calculation(DomainEntity):
    ...
    def fail_calculation(
        self, error_message: str, error_code: str = "CALCULATION_ERROR"
    ) -> None:
        """
            ...
            "result": (
                {
                    ...
                    "best_move": (
                        str(self._result.best_move) if self._result.best_move else None
                    ),
