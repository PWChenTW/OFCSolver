...
from ...value_objects import ExpectedValue, Move, Probability
...
class StrategyNode(DomainEntity):
    ...
    def is_terminal(self) -> bool:
        ...
        return (
            ...
            or self._position.is_terminal_position()
        )
    ...
    def expand_node(self, max_children: Optional[int] = None) -> List["StrategyNode"]:
        ...
        for move in legal_moves:
            ...
            child_type = (
                NodeType.TERMINAL
                if new_position.is_terminal_position()
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "expected_value": (
                self._expected_value.to_dict() if self._expected_value else None
            ),
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"StrategyNode(id={self.id}, depth={self._depth}, "
