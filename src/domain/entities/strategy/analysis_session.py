...
from ...value_objects import ConfidenceInterval, Strategy
...
class AnalysisSession(AggregateRoot):
    ...
    def fail_analysis(
        self, error_message: str, error_code: str = "ANALYSIS_ERROR"
    ) -> None:
        """
    ...
    def update_progress(
        self, progress_percentage: float, current_step: str = ""
    ) -> None:
        """
    ...
    def get_session_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "optimal_strategy": (
                self._optimal_strategy.to_dict() if self._optimal_strategy else None
            ),
