...
class Round(DomainEntity):
    ...
    def get_players_remaining(self) -> List[PlayerId]:
        ...
        return [
            player_id for player_id in self._player_ids
    ...
    def get_turn_order(self) -> List[PlayerId]:
        ...
        return (self._player_ids[start_index:] + 
                self._player_ids[:start_index])
    ...
    def _advance_turn(self) -> None:
        ...
        for _ in range(len(self._player_ids)):
            self._current_player_index = (self._current_player_index + 1) % len(self._player_ids)
    ...
    def __repr__(self) -> str:
        ...
        return (f"Round(id={self.id}, number={self._round_number}, "
