...
class DistributedCacheManager:
    ...
    def __init__(
        ...
        # Statistics
        self.stats = {"reads": {}, "writes": {}, "failures": {}}
    ...
    def _replicate_write(
        self, key: str, value: Any, expire: Optional[timedelta], primary_node: CacheNode
    ) -> None:
    ...
    def _failover_get(self, key: str, exclude_node: CacheNode) -> Optional[Any]:
        ...
        failover_nodes = [n for n in self.nodes if n != exclude_node and n.is_healthy]
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        results = {"healthy_nodes": 0, "unhealthy_nodes": 0, "nodes": {}}
