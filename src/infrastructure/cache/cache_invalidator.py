...
class CacheInvalidator:
    ...
    def invalidate_game_data(self, game_id: str) -> int:
        ...
        self._record_invalidation(
            InvalidationReason.GAME_COMPLETED,
            affected_keys,
            {"game_id": game_id}
        )
    ...
    def invalidate_user_data(self, user_id: str) -> int:
        ...
        self._record_invalidation(
            InvalidationReason.MANUAL_FLUSH,
            affected_keys,
            {"user_id": user_id}
        )
    ...
    def invalidate_by_rule_change(self, rule_type: str) -> int:
        ...
        self._record_invalidation(
            InvalidationReason.RULE_CHANGE,
            affected_keys,
            {"rule_type": rule_type}
        )
        
        logger.warning(f"Invalidated {total_invalidated} keys due to rule change: {rule_type}")
