...
class AnalysisRequest(BaseModel):
    ...
    calculation_mode: str = Field(default="standard", description="Calculation mode: instant, standard, exhaustive")
    max_calculation_time_seconds: int = Field(default=60, description="Maximum calculation time")
    monte_carlo_samples: Optional[int] = Field(default=None, description="Number of Monte Carlo samples")
    force_recalculate: bool = Field(default=False, description="Force recalculation even if cached")
