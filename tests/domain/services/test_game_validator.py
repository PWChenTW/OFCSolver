...
class TestGameValidator:
    ...
    def test_validate_row_strength_progression_fouled_player(self):
        ...
        self.player1._bottom_row = self.test_cards[8:13] if len(self.test_cards) >= 13 else self.test_cards[8:] + [Card.from_string("2h"), Card.from_string("3s")]
    ...
    def test_validate_row_strength_progression_invalid_card_counts(self):
        ...
        self.player1._bottom_row = self.test_cards[7:] + [Card.from_string("2h")]  # Try to make 5 cards
    ...
    def test_validate_row_strength_progression_valid(self):
        ...
        middle_cards = [
            ...
            Card.from_string("Kc"), Card.from_string("Qd"), Card.from_string("Jc")
        ]
    ...
    def test_can_place_card_safely_fouling_warning(self):
        ...
        self.player1._middle_row = [Card.from_string("9s"), Card.from_string("8h"), Card.from_string("7d")]
        self.player1._bottom_row = [Card.from_string("6s"), Card.from_string("5h"), Card.from_string("4c")]
