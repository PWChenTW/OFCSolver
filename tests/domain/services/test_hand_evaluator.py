...
class TestHandEvaluator:
    ...
    def test_evaluate_hand_invalid_size(self):
        ...
        with pytest.raises(ValueError, match="Hand must have 3-5 cards"):
            self.evaluator.evaluate_hand([Card.from_string("As"), Card.from_string("Kh")])
        
        # Too many cards  
        with pytest.raises(ValueError, match="Hand must have 3-5 cards"):
            self.evaluator.evaluate_hand([
                Card.from_string("As"), Card.from_string("Kh"), Card.from_string("Qc"),
                Card.from_string("Jd"), Card.from_string("Ts"), Card.from_string("9h")
            ])
...
class TestHandEvaluationBasicHands:
    ...
    def test_evaluate_high_card(self):
        ...
        cards = [
            Card.from_string("As"), Card.from_string("Kh"), Card.from_string("Qc"),
            Card.from_string("Jd"), Card.from_string("9s")
        ]
    ...
    def test_evaluate_pair(self):
        ...
        cards = [
            ...
            Card.from_string("Qd"), Card.from_string("Js")
        ]
    ...
    def test_evaluate_two_pair(self):
        ...
        cards = [
            Card.from_string("As"), Card.from_string("Ah"), Card.from_string("Kc"),
            Card.from_string("Kd"), Card.from_string("Qs")
        ]
    ...
    def test_evaluate_wheel_straight(self):
        ...
        cards = [
            Card.from_string("As"), Card.from_string("2h"), Card.from_string("3c"),
            Card.from_string("4d"), Card.from_string("5s")
        ]
    ...
    def test_evaluate_flush(self):
        ...
        cards = [
            ...
            Card.from_string("Js"), Card.from_string("9s")
        ]
    ...
    def test_evaluate_straight_flush(self):
        ...
        cards = [
            Card.from_string("9s"), Card.from_string("Ts"), Card.from_string("Js"),
            Card.from_string("Qs"), Card.from_string("Ks")
        ]
    ...
    def test_evaluate_royal_flush(self):
        ...
        cards = [
            Card.from_string("As"), Card.from_string("Ks"), Card.from_string("Qs"),
            Card.from_string("Js"), Card.from_string("Ts")
        ]
...
class TestHandEvaluationThreeCardHands:
    ...
    def test_evaluate_three_card_pair_with_royalty(self):
        ...
        # Test higher pair
        ace_pair_cards = [Card.from_string("As"), Card.from_string("Ah"), Card.from_string("Kc")]
...
class TestHandComparison:
    ...
    def test_compare_hands_different_types(self):
        ...
        high_card_cards = [Card.from_string("As"), Card.from_string("Kh"), Card.from_string("Qc")]
        
        pair_ranking = self.evaluator.evaluate_hand(pair_cards)
        high_card_ranking = self.evaluator.evaluate_hand(high_card_cards)
        
        assert self.evaluator.compare_hands(pair_ranking, high_card_ranking) == 1  # Pair wins
        assert self.evaluator.compare_hands(high_card_ranking, pair_ranking) == -1  # High card loses
    
    def test_compare_hands_same_type(self):
        """Test comparing hands of same type."""
        ace_pair_cards = [Card.from_string("As"), Card.from_string("Ah"), Card.from_string("Kc")]
        king_pair_cards = [Card.from_string("Ks"), Card.from_string("Kh"), Card.from_string("Ac")]
        ...
        assert self.evaluator.compare_hands(king_pair, ace_pair) == -1  # King pair loses
    
    def test_compare_hands_tie(self):
        """Test comparing identical hands."""
        cards1 = [Card.from_string("As"), Card.from_string("Ah"), Card.from_string("Kc")]
        cards2 = [Card.from_string("Ad"), Card.from_string("Ac"), Card.from_string("Kd")]
...
class TestOFCValidation:
    ...
    def test_validate_ofc_progression_valid(self):
        ...
        is_valid = self.evaluator.validate_ofc_progression(top_cards, middle_cards, bottom_cards)
        assert is_valid
...
class TestRoyaltyCalculation:
    ...
    def test_top_row_royalty_calculation(self):
        ...
        sixes_cards = [Card.from_string("6s"), Card.from_string("6h"), Card.from_string("Kc")]
        ...
        aces_cards = [Card.from_string("As"), Card.from_string("Ah"), Card.from_string("Kc")]
        aces_ranking = self.evaluator.evaluate_hand(aces_cards)
        assert aces_ranking.royalty_bonus == 9  # 14 - 5 = 9
        
        # Three of a kind
        trips_cards = [Card.from_string("2s"), Card.from_string("2h"), Card.from_string("2c")]
...
class TestEdgeCases:
    ...
    def test_straight_edge_cases(self):
        ...
        regular_straight = [Card.from_string("5s"), Card.from_string("6h"), Card.from_string("7c"),
                          Card.from_string("8d"), Card.from_string("9s")]
        ranking = self.evaluator.evaluate_hand(regular_straight)
        assert ranking.hand_type == HandType.STRAIGHT
        assert ranking.strength_value == 9  # 9-high straight
        
        # Wheel straight
        wheel_straight = [Card.from_string("As"), Card.from_string("2h"), Card.from_string("3c"),
                         Card.from_string("4d"), Card.from_string("5s")]
    ...
    def test_flush_vs_straight(self):
        ...
        assert self.evaluator.compare_hands(flush_ranking, straight_ranking) == 1  # Flush wins
    
    def test_kicker_comparison(self):
        """Test kicker comparison for same hand types."""
        # Two pairs with different kickers
        pair1_cards = [Card.from_string("As"), Card.from_string("Ah"), Card.from_string("Kc"),
                      Card.from_string("Qd"), Card.from_string("Js")]
        pair2_cards = [Card.from_string("Ad"), Card.from_string("Ac"), Card.from_string("Kd"),
                      Card.from_string("Qh"), Card.from_string("Ts")]
