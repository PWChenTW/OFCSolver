...
class TestHandRankingComparison:
    ...
    def test_compare_to_same_type_different_strength(self):
        ...
        king_pair = HandRanking(
            ...
            kickers=[14],
            royalty_bonus=0,
            cards=[Card.from_string("Ks"), Card.from_string("Kh"), Card.from_string("Ac")]
        )
    ...
    def test_compare_to_same_strength_different_kickers(self):
        ...
        pair_queen_kicker = HandRanking(
            ...
            royalty_bonus=0,
            cards=[Card.from_string("As"), Card.from_string("Ah"), Card.from_string("Qc"),
                   Card.from_string("Jd"), Card.from_string("9s")]
        )
        
        assert pair_king_kicker.compare_to(pair_queen_kicker) == 1  # King kicker wins
        assert pair_queen_kicker.compare_to(pair_king_kicker) == -1  # Queen kicker loses
    ...
    def test_compare_to_tie(self):
        ...
        hand2 = HandRanking(
            ...
            kickers=[13, 12],
            royalty_bonus=0,
            cards=[Card.from_string("Ad"), Card.from_string("Ac"), Card.from_string("Kd")]
        )
...
class TestHandRankingDescription:
    ...
    def test_get_hand_description_straight(self):
        ...
        wheel = HandRanking(
            ...
            kickers=[],
            royalty_bonus=0,
            cards=[Card.from_string("5s"), Card.from_string("4h"), Card.from_string("3c"),
                   Card.from_string("2d"), Card.from_string("As")]
        )
