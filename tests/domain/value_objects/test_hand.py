...
from src.domain.value_objects.hand import Hand, HandValidationError, InvalidCardPlacementError
...
class TestHandCreation:
    ...
    def test_hand_validation_row_size_limits(self):
        ...
        with pytest.raises(HandValidationError, match="Top row cannot have more than 3 cards"):
            Hand.from_layout(
                top=[Card.from_string("As"), Card.from_string("Kh"), 
                     Card.from_string("Qc"), Card.from_string("Jd")],  # 4 cards
                middle=[],
                bottom=[]
            )
        
        # Too many cards in middle row
        with pytest.raises(HandValidationError, match="Middle row cannot have more than 5 cards"):
            Hand.from_layout(
                top=[],
                middle=[Card.from_string("As"), Card.from_string("Kh"), 
                       Card.from_string("Qc"), Card.from_string("Jd"),
                       Card.from_string("Ts"), Card.from_string("9h")],  # 6 cards
                bottom=[]
            )
        
        # Too many cards in bottom row
        with pytest.raises(HandValidationError, match="Bottom row cannot have more than 5 cards"):
            Hand.from_layout(
                top=[],
                middle=[],
                bottom=[Card.from_string("As"), Card.from_string("Kh"), 
                       Card.from_string("Qc"), Card.from_string("Jd"),
                       Card.from_string("Ts"), Card.from_string("9h")]  # 6 cards
            )
    ...
    def test_hand_validation_too_many_cards(self):
        ...
        cards = [Card.from_string(f"{rank}s") for rank in "23456789TJQKA"] + [Card.from_string("2h")]
        
        with pytest.raises(HandValidationError, match="Hand cannot contain more than 13 cards"):
    ...
    def test_hand_from_cards_too_many(self):
        ...
        with pytest.raises(HandValidationError, match="Cannot create hand with more than 13 cards"):
            Hand.from_cards(cards)
...
class TestHandProperties:
    ...
    def test_is_complete(self):
        ...
        complete_hand = Hand.from_layout(
            top=[Card.from_string("As"), Card.from_string("Kh"), Card.from_string("Qc")],
            middle=[Card.from_string("Jd"), Card.from_string("Ts"), Card.from_string("9h"),
                   Card.from_string("8c"), Card.from_string("7d")],
            bottom=[Card.from_string("6s"), Card.from_string("5h"), Card.from_string("4c"),
                   Card.from_string("3d"), Card.from_string("2s")]
        )
...
class TestHandCardPlacement:
    ...
    def test_place_card_not_available(self):
        ...
        with pytest.raises(InvalidCardPlacementError, match="Card As is not available to place"):
    ...
    def test_place_card_position_full(self):
        ...
        hand = Hand.from_layout(
            top=[Card.from_string("As"), Card.from_string("Kh"), Card.from_string("Qc")],  # Full
            middle=[],
            bottom=[],
            hand=[card_to_place]
        )
        
        with pytest.raises(InvalidCardPlacementError, match="Cannot place card in CardPosition.TOP"):
    ...
    def test_remove_card_not_found(self):
        ...
        with pytest.raises(InvalidCardPlacementError, match="Card As not found in any row"):
...
class TestHandImmutability:
    ...
    def test_hand_immutable(self):
        ...
        original_hand = Hand.from_cards([Card.from_string("As"), Card.from_string("Kh")])
