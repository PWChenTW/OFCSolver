...
def test_position_caching():
    ...
    # Cache analysis
    success = cache_manager.set_analysis(position_hash, "minimax_alphabeta", analysis_result)
...
def test_strategy_calculator_caching():
    ...
    remaining_deck = [
        Card.from_string("Th"), Card.from_string("9h"),
        Card.from_string("8c"), Card.from_string("7c"),
        Card.from_string("6d"), Card.from_string("5d")
    ]
